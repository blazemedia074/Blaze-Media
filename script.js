...
function scrollToTarget() {
    ...
    element.scrollIntoView({ behavior: "smooth" }); // smooth بتخلي الحركة ناعمة
  }
btnW.onclick= () => {
    ...
    c32.innerHTML=`${x} 4 Professional designs`
    c33.innerHTML=`${x} 3 Reels`
